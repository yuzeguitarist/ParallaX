...
impl CidQueue {
    ...
    // PARALLAX FORK: 5 -> 64. Sizes the remote-CID ring buffer (and, via
    // transport_parameters.rs, the advertised active_connection_id_limit) to
    // Safari-26's confirmed value of 64. CidQueue is pure modular ring-buffer
    // arithmetic with no power-of-two/bitmask assumption, so any positive LEN is
    // correct. See vendor/quinn-proto/PARALLAX_FORK.md.
