...
| Data plane | ChaCha20-Poly1305 records (96-bit nonce) inside TLS `ApplicationData` | [`../src/protocol/data.rs`](../src/protocol/data.rs), [`../src/crypto/parallel.rs`](../src/crypto/parallel.rs), [`Session Key Derivation & AEAD Transport`](Session-Key-Derivation-&-AEAD-Transport.md) |
...
| Encrypted records and relay payloads | `PX1C`, `PX1Q`, `PX1K`, `PX1S`, `ApplicationData`, `ChaCha20-Poly1305` | [`Protocol Commands & Data Records`](Protocol-Commands-&-Data-Records.md) |
| Performance or throughput evidence | `plx speed`, `plx bench`, `network evidence`, `benchmark`, `58 cases` | [`Probing & Benchmarking`](<Probing-&-Benchmarking.md>), [`Protocol Benchmarks`](Protocol-Benchmarks.md) |
