...
| Data plane | XChaCha20-Poly1305 records inside TLS `ApplicationData` | [`../src/protocol/data.rs`](../src/protocol/data.rs), [`../src/crypto/parallel.rs`](../src/crypto/parallel.rs), [`Session Key Derivation & AEAD Transport`](Session-Key-Derivation-&-AEAD-Transport.md) |
